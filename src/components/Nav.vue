<template>
  ...
  <div class="wrap">
    ...
    <div class="right-frame-top">
      <div class="banner">TASKK &#149; APP</div>
      <div class="data-cascade-button-group">
        ...
        <div class="button-col">
          <div class="button" id="top-left"><a href="">Welcome</a></div>
          <div class="button" id="bottom-left"><a href="">Functions</a></div>
        </div>
        <div class="button-col">
          <div class="button" id="top-right"><a href=""><span class="">{{emailName[0]}}</span></a></div>  
